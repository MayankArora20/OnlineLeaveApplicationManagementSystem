...
<h1><center>Decline Detail</center></h1>
<body bgcolor="#fffacd">
...
<center>
<table  style ="width:60% ;margin:auto; padding:5px;" border="5" bgcoclor="blue">
...
$query1="select appId from link where status ='decline' and tid='".$tid."'";
